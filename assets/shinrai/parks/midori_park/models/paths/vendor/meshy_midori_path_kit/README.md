...
The source meshes remain unchanged. `midori_park_size_blockout.gd` performs the reversible orientation, scale, grounding, collision, and cyan texture-mask emission pass at runtime. The existing blockout paths stay beneath phase one until the resting-pocket module arrives and the final circulation layout is approved.
