...
- One supplied Japanese maple is used as a single hero accent; the second distinct maple remains unplaced until its 3D Warehouse download is supplied. The existing ash/oak-like broadleaf pack is not relabelled as maple.
- The supplied Midnight Fern creates small, irregular mainland floor pockets beneath and between groves; it is decorative, reduced in scale, and kept off the lake islands.
