# SHINRAI Yakitori Shop — Artwork Replica v5
...
## V5 close-up corrections

- Side and rear plaster are continuous: no joint meshes, grooves, battens, or decals
- Plaster, stone, and roof textures are recolored to the artwork swatches
- The upper roof is smaller, lower, and seated on sloped plaster closures with no open wedge
- The storefront canopy is a newly authored thin 2° roof skin, not the old balcony-like slab
- Canopy roof, metal flashing, timber soffit, and support brackets are separate layers
- Front fascia and other long timber members use corrected horizontal grain direction
- Ground-floor plaster piers stop below the canopy instead of protruding through it
- Roof surfaces are matte charcoal and separate from metallic edge flashing
