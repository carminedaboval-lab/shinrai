...
func _build_sakura_trees(parent: Node3D) -> void:
	...
	var placements: Array[Vector3] = [
		...
		Vector3(-30.0, 0.0, -15.0), Vector3(-22.0, 0.0, 18.0), Vector3(-5.0, 0.0, 38.0),
		Vector3(25.0, 0.0, 40.0), Vector3(58.0, 0.0, 31.0), Vector3(82.0, 0.0, 17.0),
		Vector3(85.0, 0.0, -8.0), Vector3(82.0, 0.0, -36.0), Vector3(55.0, 0.0, -53.0),
		...
		Vector3(90.0, 0.0, 35.0), Vector3(90.0, 0.0, -55.0), Vector3(40.0, 0.0, -68.0),
	]
...
func _build_size_hud() -> void:
	...
	label.text = "MIDORI PARK SIZE REVIEW\n220 m x 180 m | 39,600 m² | diagonal 284 m\nOrange = entrances | Grey = loop/main paths\nVegetation: 48 dense sakura trees and 30 evergreen shrubs."
